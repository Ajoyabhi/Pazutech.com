...
<body>
    ...
    <div class="breadcrumb-area breadcrumb-upi">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb_box text-center">
                        ...
                        <h3 class="breadcrumb-title" style="color:white;">UPI Collection API</h3>
                        ...
                        <ul class="breadcrumb-list">
                            ...
                            <li class="breadcrumb-item active">UPI Collection API</li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="section-title-wrap text-center section-space--mb_60">
                                ...
                                <h3 class="heading">UPI Collection  <span class="text-color-primary"> API</span></h3>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="modern-number-01">
                                    <img class="img-fulid" width="100%" src="assets/images/bg/upi-01.jpeg" alt="">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="cybersecurity-about-text">
                                    ...
                                    <div class="text">
                                    PayzuTech provide Unified Payment Interface (UPI) collection
                                        API whose process is very simple and accessible for 3rd party
                                        applications. It is a payment gateway Interface that allows merchants to
                                        collect payments from their customers through Unified Payments
                                        Interface(UPI), real time interbank electronic fund transfer system in
                                        India.

                                        The API enables merchants to integrate UPI payment options into their
                                        website or mobile applications and it provides their partners to collect a
                                        payment through UPI via static QR code or Dynamic QR code or intent
                                        link which is directly settled in partners current account.
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="section-title-wrap text-center section-space--mb_30">
                                <h3 class="heading">Key point of UPI Collection <span class="text-color-primary">API</span></h3>
                            </div>
                            <!-- section-title-wrap Start -->
                        </div>
                    </div>
                            ...
                            <div class="single-item col-lg-4 col-md-6 mt-30 wow move-up">
                                ...
                                <a href="#" class="ht-box-images style-04">
                                    <div class="image-box-wrap">
                                        ...
                                        <div class="content">
                                            <h5 class="heading">Easy Integration</h5>
                                            <div class="text">
                                            PayzuTech provides user friendly interfaces, and tools and keeps things easy to navigate, ensuring users enjoy a seamless and visually pleasing online experiences.
                                            </div>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="single-item col-lg-4 col-md-6 mt-30 wow move-up">
                                ...
                                <a href="#" class="ht-box-images style-04">
                                    <div class="image-box-wrap">
                                        ...
                                        <div class="content">
                                            <h5 class="heading">High TPS</h5>
                                            <div class="text">
                                            PayzuTech provides high transaction per second and optimizing server performance, employing efficient database systems, and leveraging caching mechanisms. Ensure swift data processing for an exceptional user experience.
                                            </div>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="single-item col-lg-4 col-md-6 mt-30 wow move-up">
                                ...
                                <a href="#" class="ht-box-images style-04">
                                    <div class="image-box-wrap">
                                        ...
                                        <div class="content">
                                            <h5 class="heading">First Reconciliation</h5>
                                            <div class="text">
                                            PayzuTech provides the integrity, systematically reviewing data, resolving issues and an easy way to control, ensures accuracy and effective information presented.
                                            </div>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="single-item col-lg-4 col-md-6 mt-30 wow move-up">
                                ...
                                <a href="#" class="ht-box-images style-04">
                                    <div class="image-box-wrap">
                                        ...
                                        <div class="content">
                                            <h5 class="heading">Single account for all service</h5>
                                            <div class="text">
                                            PayzuTech simplifying user experiences. Streamline access to diverse features, from project management to resource utilization, ensuring efficiency and convenience through unified account management.
                                            </div>
                                        </div>
                                    </div>
                                </a>
                                ...
                                <a href="#" class="ht-box-images style-04">
                                    <div class="image-box-wrap">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="text">
                                            PayzuTech provides real-time project updates, task management, and performance system, empowering users with a consolidated view for decision-making and smooth navigation.
                                            </div>
                                        </div>
                                    </div>
                                </a>
                            ...
                            <div class="single-item col-lg-4 col-md-6 mt-30 wow move-up">
                                ...
                                <a href="#" class="ht-box-images style-04">
                                    <div class="image-box-wrap">
                                        ...
                                        <div class="content">
                                            <h5 class="heading">API Lifecycle Management</h5>
                                            <div class="text">
                                            PayzuTech ensure seamless integration. Efficient management enhances functionality, reliability, and scalability for improved user experiences.
                                            </div>
                                        </div>
                                    </div>
                                </a>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="image-inner-video-section">
                                <img class="img-fluid border-radus-5" style="margin-top: 50px;" src="assets/images/bg/upi-collection-02.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6 ms-auto mt-30">
                            <div class="machine-learning-about-content">
                                <div class="section-title mb-20">
                                    <h4>Facilitate Instant Payments</h4>
            ...
            <div class="machine-learning-about-company-area section-space--pt_50 section-space--pb_30" style="margin-top: 70px;">
                <div class="container">
                    ...
                    <div class="col-lg-6 ms-auto mt-30">
                            <div class="machine-learning-about-content">
                                <div class="section-title mb-20">
                                    <h4>Set-up Intent Flows & QR Collections</h4>
                                    <p class="dec-text mt-20">
                        ...
                        <div class="col-lg-6">
                            <div class="image-inner-video-section">
                                <img class="img-fluid border-radus-5" style="margin-top: 50px;" src="assets/images/banners/search-engine-marketing.png" alt="">
                            </div>
                        </div>
            ...
            <div class="machine-learning-about-company-area section-space--pt_50 section-space--pb_30" style="margin-top: 70px;">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="image-inner-video-section">
                                <img class="img-fluid border-radus-5" style="margin-top: 50px;" src="assets/images/banners/search-engine-optimization.webp" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6 ms-auto mt-30">
                            <div class="machine-learning-about-content">
                                <div class="section-title mb-20">
                                    <h4>Enable UPI Autoplay & Split Payments</h4>
                                    <p class="dec-text mt-20">
